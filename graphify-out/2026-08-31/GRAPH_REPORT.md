...
## Corpus Check
- 550 files · ~348,639 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5515 nodes · 7038 edges · 513 communities (372 shown, 141 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 36 edges (avg confidence: 0.66)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9c17d5ae`
...
- resolve_and_verify_all_catalog_urls.py
...
## Communities (513 total, 141 thin omitted)
...
Cohesion: 0.07
Nodes (30): ../../domain/models/vehicle_analytics.dart, _SocialButton, build, _buildSpecialOffer, imageUrl, isDark, MarketplaceTalleresScreen, rating (+22 more)

### Community 7 - "renderReport"
Cohesion: 0.18
Nodes (19): asArray(), assertValidObservations(), candidateForDisplay(), displayCandidateObject(), displayCandidateRef(), formatEvidenceText(), formatRecommendationText(), impactString() (+11 more)
...
### Community 34 - "package:supabase_flutter/supabase_flutter.dart"
Cohesion: 0.13
...
### Community 68 - "verify-and-regen.mjs"
Cohesion: 0.27
...
Cohesion: 0.15
Nodes (13): build, _openFullScreenViewer, _buildIssueItem, _abrirBitacoraTanqueo, _abrirGarajeSelector, _abrirGuias, _abrirHistorialRutas, _abrirParametrizacion (+5 more)
...
### Community 84 - "readCacheInvalidationFiles"
Cohesion: 0.15
...
### Community 86 - "package:latlong2/latlong.dart"
Cohesion: 0.15
...
### Community 89 - "grade-recommendation.mjs"
Cohesion: 0.39
...
### Community 92 - "vehicle_health_logic.dart"
Cohesion: 0.17
...
### Community 94 - "State"
Cohesion: 0.06
Nodes (43): PulsingLocationMarker, _PulsingLocationMarkerState, RutasScreen, _RutasScreenState, _ScaleButton, _ScaleButtonState, _StaggeredFadeIn, _StaggeredFadeInState (+35 more)
...
Cohesion: 0.05
Nodes (46): core/theme/app_apple_theme.dart, dart:ui, DateTime?, ios_cupertino_date_sheet.dart, ios_health_gauge.dart, accentColor, build, IosEvidenceGallery (+38 more)
...
### Community 132 - "verifyNextCacheLifetimeFreshnessSupported"
Cohesion: 0.24
...
Cohesion: 0.08
Nodes (25): Architecture Pattern, Branch Optimization, Command Line Tools, Common Anti-Patterns, Compute Optimization, Core Principles, Data Types, Debug Utility Functions (+17 more)
...
Cohesion: 0.08
Nodes (24): Accessibility Considerations, Android Animation APIs, Arc Motion, Bottom Sheet, Cards, Choreography, Component-Specific Motion, Curve Values (Cubic Bezier) (+16 more)
...
Cohesion: 0.08
Nodes (26): 10.1 Common SwiftUI Property Wrappers, 10.2 Custom Property Wrappers, 10. Property Wrappers, 4.1 Prefer Structs (Value Types), 4.2 Use Classes When Needed, 4.3 Enums for Finite States, 4. Value Types vs Reference Types, 5.1 Breaking Retain Cycles with weak (+18 more)
...
### Community 191 - "Checklist"
Cohesion: 0.10
Nodes (21): Accessibility, Accessibility, Checklist, Colors, Colors, Components, Core Principles, iOS Application Development Guide (+13 more)
...
### Community 219 - "motorcycle_manuals_repository.dart"
Cohesion: 0.20
...
### Community 259 - "package:flutter/material.dart"
Cohesion: 0.10
Nodes (18): ../../../core/services/waze_community_alerts_service.dart, build, _buildReportOption, currentLat, currentLng, _sendReport, show, WazeReportSheet (+10 more)
...
### Community 345 - "audit_vehicle_url_match.py"
Cohesion: 0.47
Nodes (5): check_match(), extract_filename_from_url(), get_exact_commons_image(), main(), Busca en Wikimedia Commons un archivo de imagen específico con el modelo.
...
### Community 482 - "Focus and Navigation"
Cohesion: 0.40
...
### Community 484 - "Transition Patterns"
Cohesion: 0.40
Nodes (5): Container Transform, Fade, Fade Through, Shared Axis, Transition Patterns
...
### Community 486 - "resolve_and_verify_all_catalog_urls.py"
Cohesion: 0.60
Nodes (3): get_wiki_image(), main(), resolve_model()

### Community 487 - "lib/render-report.mjs"
Cohesion: 0.12
Nodes (30): buildFinalReportMessage(), canonicalRefOf(), compactFinalText(), costRoundsToCents(), displayCandidate(), enrichRecFromCandidates(), escape(), extractCoverageLine() (+22 more)
...
### Community 498 - "Testing Accessibility"
Cohesion: 0.50
Nodes (4): Automated Testing, Checklist, Manual Testing, Testing Accessibility

### Community 499 - "Duration Guidelines"
Cohesion: 0.50
Nodes (4): By Device Type, By Interaction Type, Duration Guidelines, Duration Rules
