...
## Corpus Check
- 509 files · ~315,482 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5081 nodes · 6471 edges · 474 communities (339 shown, 135 thin omitted)
...
## Communities (474 total, 135 thin omitted)

### Community 0 - "inicio_app.dart"
Cohesion: 0.02
Nodes (111): Agregar_carro.dart, Agregar_vehiculo.dart, ../../ai_bot/presentation/ai_chat_screen.dart, ../../auth/login_screen.dart, captura_360_screen.dart, ../../../core/services/calendar_sync_service.dart, ../../../core/services/odometer_history_service.dart, ../../../core/services/vehicle_pdf_report_service.dart (+103 more)
...
Cohesion: 0.07
Nodes (30): ../../../core/logic/pdf_report_logic.dart, ../../../core/logic/vehicle_expenses_logic.dart, ../../../../core/services/supabase_service.dart, CustomPainter, apodo, brandLogoPath, build, _BuildEmptyState (+22 more)
...
Cohesion: 0.08
Nodes (26): Animation, AnimationController, build, _check, color, _controller, createState, dispose (+18 more)
...
Cohesion: 0.05
Nodes (41): _SocialButton, _ExpenseTile, GuiaScreen, _OpcionCard, _PasoCard, _VideoTutorialCard, DashedLineConnector, _LocationRow (+33 more)
...
Cohesion: 0.06
Nodes (45): SuccessCheckmark, _SuccessCheckmarkState, PulsingLocationMarker, _PulsingLocationMarkerState, DocumentViewerScreen, _DocumentViewerScreenState, InicioApp, _InicioAppState (+37 more)
...
Cohesion: 0.08
Nodes (22): dart:math, calculateEfficiencyScore, calculateSavings, FuelEfficiencyLogic, getEfficiencyLabel, analyzeAdaptiveMaintenance, analyzeJourneyPatterns, _calculateCareScore (+14 more)
...
### Community 278 - "missing-cache-headers.mjs"
Cohesion: 0.67
Nodes (3): isApplicable(), metadata, scan()
...
## Knowledge Gaps
- **2889 isolated node(s):** `evaluate-session.sh script`, `deploy-codex.sh script`, `deploy.sh script`, `HERE`, `LIBRARY_PATH` (+2884 more)
...
- **Why does `scanners` connect `gates/index.mjs` to `workspace-resolver.mjs`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `Swift Coding Standards` connect `Swift Coding Standards` to `3. Protocol-Oriented Design`, `2. Naming Conventions`, `6. Error Handling`, `Quick Reference`, `8. Access Control`, `4. Value Types vs Reference Types`, `1. Optionals and Safety`, `7. Modern Concurrency (async/await)`, `Checklist`, `9. Generics and Type Constraints`, `ios-application-dev/SKILL.md`?**
...
- **Should `inicio_app.dart` be split into smaller, more focused modules?**
  _Cohesion score 0.019144144144144143 - nodes in this community are weakly interconnected._
